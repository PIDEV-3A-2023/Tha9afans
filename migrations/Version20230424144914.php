 ...
 */
final class Version20230424144914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE payment_s');
        $this->addSql('DROP TABLE stripep');
        $this->addSql('ALTER TABLE billet DROP FOREIGN KEY bille-ev');
        $this->addSql('ALTER TABLE billet DROP FOREIGN KEY bille-ev');
        $this->addSql('ALTER TABLE billet ADD type VARCHAR(255) NOT NULL, ADD nbr_billet_available INT NOT NULL, CHANGE id_evenement id_evenement INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE panierproduit DROP FOREIGN KEY fkidpanier');
        $this->addSql('ALTER TABLE panierproduit DROP Subtotal, CHANGE id_panier id_panier INT DEFAULT NULL, CHANGE id_produit id_produit INT DEFAULT NULL, CHANGE ispayed ispayed TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment_s (id INT AUTO_INCREMENT NOT NULL, card_number VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, card_holder VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, cvv INT DEFAULT NULL, date DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE stripep (id INT AUTO_INCREMENT NOT NULL, card_number VARCHAR(16) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, card_holder VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, expiration_month INT DEFAULT NULL, expiration_year VARCHAR(11) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, cvv VARCHAR(3) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE billet DROP FOREIGN KEY FK_1F034AF68B13D439');
        $this->addSql('ALTER TABLE billet DROP FOREIGN KEY FK_1F034AF68B13D439');
        $this->addSql('ALTER TABLE billet DROP type, DROP nbr_billet_available, CHANGE id_evenement id_evenement INT NOT NULL');
        $this->addSql('ALTER TABLE billet ADD CONSTRAINT bille-ev FOREIGN KEY (id_evenement) REFERENCES evenement (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE panierproduit ADD Subtotal DOUBLE PRECISION NOT NULL, CHANGE id_panier id_panier INT NOT NULL, CHANGE id_produit id_produit INT NOT NULL, CHANGE ispayed ispayed TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE panierproduit ADD CONSTRAINT fkidpanier FOREIGN KEY (id_panier) REFERENCES panier (id) ON DELETE CASCADE');
