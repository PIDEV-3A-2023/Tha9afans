 ...
 */
final class Version20230416233515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE dateCommande datecommande DATETIME NOT NULL, CHANGE id_produit id_produit INT DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE payment_s CHANGE card_number card_number VARCHAR(50) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE produit ADD qt INT NOT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE image image LONGBLOB DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservation CHANGE status status VARCHAR(20) NOT NULL, CHANGE payment_info payment_info VARCHAR(255) NOT NULL, CHANGE total_price total_price INT NOT NULL, CHANGE payment_status payment_status VARCHAR(50) NOT NULL, CHANGE location location VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP FOREIGN KEY FK_B26681E73A201E5');
        $this->addSql('ALTER TABLE evenement CHANGE categorie_id categorie_id INT NOT NULL, CHANGE createur_id createur_id INT NOT NULL');
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT fk_pers FOREIGN KEY (createur_id) REFERENCES personnes (id)');
        ...
        $this->addSql('ALTER TABLE payment_s CHANGE card_number card_number INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE produit DROP qt, CHANGE categorie_id categorie_id INT NOT NULL, CHANGE image image BLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT fk_vendeur FOREIGN KEY (vendeur_id) REFERENCES personnes (id)');
        ...
        $this->addSql('ALTER TABLE quiz_question ADD CONSTRAINT FK_6033B00B853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (quiz_id)');
        $this->addSql('ALTER TABLE quiz_question ADD CONSTRAINT FK_6033B00B1E27F6BF FOREIGN KEY (question_id) REFERENCES question (question_id)');
        $this->addSql('ALTER TABLE reservation CHANGE status status VARCHAR(20) DEFAULT NULL, CHANGE payment_info payment_info VARCHAR(255) DEFAULT NULL, CHANGE total_price total_price INT DEFAULT NULL, CHANGE payment_status payment_status VARCHAR(50) DEFAULT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL');
