 ...
 */
final class Version20230411211200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billet (id INT AUTO_INCREMENT NOT NULL, id_evenement INT DEFAULT NULL, code VARCHAR(255) NOT NULL, date_validite DATE DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, nbr_billet_available INT NOT NULL, INDEX IDX_1F034AF68B13D439 (id_evenement), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, createur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(10000) NOT NULL, date DATE NOT NULL, localisation VARCHAR(255) NOT NULL, freeorpaid VARCHAR(255) NOT NULL, online VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, INDEX IDX_B26681EBCF5E72D (categorie_id), INDEX IDX_B26681E73A201E5 (createur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, date_reservation DATE NOT NULL, status VARCHAR(20) NOT NULL, payment_info VARCHAR(255) NOT NULL, total_price INT NOT NULL, payment_status VARCHAR(50) NOT NULL, INDEX IDX_42C849556B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
