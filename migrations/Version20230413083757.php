 ...
 */
final class Version20230413083757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stripep CHANGE card_number card_number VARCHAR(16) DEFAULT NULL, CHANGE card_holder card_holder VARCHAR(255) DEFAULT NULL, CHANGE expiration_month expiration_month INT DEFAULT NULL, CHANGE expiration_year expiration_year INT DEFAULT NULL, CHANGE cvv cvv INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session ADD CONSTRAINT FK_D044D5D4FD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id)');
        $this->addSql('ALTER TABLE stripep CHANGE card_number card_number VARCHAR(16) NOT NULL, CHANGE card_holder card_holder VARCHAR(255) NOT NULL, CHANGE expiration_month expiration_month INT NOT NULL, CHANGE expiration_year expiration_year INT NOT NULL, CHANGE cvv cvv INT NOT NULL');
    }
}
