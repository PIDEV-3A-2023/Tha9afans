 ...
 */
final class Version20230412092337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment_s (id INT AUTO_INCREMENT NOT NULL, card_number INT DEFAULT NULL, card_holder VARCHAR(50) DEFAULT NULL, cvv INT DEFAULT NULL, date DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
